// ===================================
// supabase.js - Elite Capital (نسخة محدثة مع نظام الباقات المتكامل)
// ===================================
...
async function createPendingPackage(pendingData) {
    try {
        ...
        const { data: pkg, error: pkgError } = await supabaseClient
            .from('packages')
            .select('id, name, category, duration, duration_type, daily_profit')
        ...
        if (pendingData.amount !== pkg.price) {
    ...
    try {
        ...
        const { data: subscription, error: subError } = await supabaseClient
            ...
            .insert([{
                ...
                daily_profit: pending.package_daily_profit || (pending.amount * 0.025), // استخدم الربح من الباقة أو احسب 2.5%
...
async function processDailyProfits() {
    try {
        ...
        for (const sub of subscriptions || []) {
            ...
            const profitAmount = sub.daily_profit; // استخدام الربح اليومي المخزن في الاشتراك
...
console.log('✅ تم تحميل جميع دوال Supabase مع نظام الباقات المتكامل');
